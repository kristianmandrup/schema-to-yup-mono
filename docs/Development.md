...
Guide on the infrastrastrucvture used

## Monorepo

- This is a [Monorepo](https://www.atlassian.com/git/tutorials/monorepos) project, which is designed for several packages to be develop separately but as well together
...
Bootstrap lerna project (install all dependencies and link lerna packages via sym-links)
